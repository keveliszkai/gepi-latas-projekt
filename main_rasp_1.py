...
darknet_folder = "/home/pingberry/darknet/"
darknet_config = "cfg/yolov2.cfg"
darknet_config = "cfg/yolov2.cfg"
#darknet_weights = "yolov2-tiny.weights"
#darknet_weights = "yolov2-tiny.weights"
#darknet_config = "cfg/yolov3-tiny.cfg"
#darknet_weights = "yolov3-tiny.weights"
darknet_data = "cfg/coco.data"

def checkImage(frame, date):
	print("START - "+datetime.datetime.now().strftime("%A %d %B %Y %I:%M:%S%p"))
	command = ["./darknet", "detector", "test", darknet_data, darknet_config, darknet_weights, current_folder + "/img.png", "/dev/null"]
